...
async function main(){
    ...
    const vnmsrc = await loadFile("./african-tangent-vertex.glsl")
    const fnmsrc = await loadFile("./african-tangent-fragment.glsl")
    const normalShader = new AriaShader(gl,vnmsrc,fnmsrc)
    ...
    function render(){
        ...
        AriaComAfrican.draw(gl,normalShader,africanBuffer,texStruct,camera)
